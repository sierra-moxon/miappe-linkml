# Contributing to miappe-linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
miappe-linkml. These guidelines are not strict rules.
...
The miappe-linkml team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the miappe-linkml technical leads
...
[issues]: https://github.com/sierra-moxon/miappe-linkml/issues/
[pulls]: https://github.com/sierra-moxon/miappe-linkml/pulls/
